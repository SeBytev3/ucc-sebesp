    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center py-20 space-y-4 animate-bounce">
          ...
          <p className="text-xl text-gray-600">Tu perfil ha sido aprobado. Ya puedes recibir solicitudes.</p>
        </div>
      </Layout>
    );
  }
        ...
        <Layout>
          <div className="bg-white rounded-3xl shadow-sm border border-indigo-100 overflow-hidden max-w-2xl mx-auto">
            <div className="bg-indigo-600 p-8 text-white text-center">
              <h2 className="text-3xl font-bold italic tracking-tighter">¡Hola, {user.firstName}!</h2>
              <p className="mt-2 text-indigo-100">Para empezar a trabajar, necesitamos conocerte.</p>
            </div>
            <div className="p-8 text-center space-y-6">
              <div className="inline-flex items-center justify-center p-4 bg-orange-50 rounded-full">
                <AlertCircle className="h-12 w-12 text-orange-500" />
              </div>
              <h3 className="text-xl font-bold text-gray-900">Tu perfil profesional está incompleto</h3>
              <p className="text-gray-600">Completa tu información para que podamos validar tu cuenta.</p>
              <Link
                to="/complete-profile"
      ...
      return (
        <Layout>
          <div className="max-w-2xl mx-auto text-center space-y-8 bg-white p-12 rounded-3xl shadow-sm border-t-8 border-yellow-400">
            ...
            <p className="text-lg text-gray-600">Estamos validando tu información profesional. Recibirás una notificación pronto.</p>
            <div className="pt-4">
              <Link to="/requests" className="text-indigo-600 font-bold hover:underline">Ir a Mis Solicitudes</Link>
            </div>
          </div>
        </Layout>
      );
      ...
      return (
        <Layout>
          <div className="max-w-2xl mx-auto text-center space-y-8 bg-white p-12 rounded-3xl shadow-sm border-t-8 border-red-500">
            ...
            <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Solicitud No Aprobada</h2>
            <div className="bg-red-50 p-6 rounded-2xl text-red-800 text-sm border border-red-100">
              ...
              <p className="italic">"{profile.rejectionReason || 'No se proporcionó un motivo específico.'}"</p>
            </div>
