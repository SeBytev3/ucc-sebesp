...
export class AdminController {
   ...
   */
  async getPendingProviders(_req: AuthRequest, res: Response) {
   ...
   */
  async approveProvider(req: AuthRequest, res: Response) {
   ...
   */
  async rejectProvider(req: AuthRequest, res: Response) {
    const id = req.params.id as string;
   ...
   */
  async deactivateProvider(req: AuthRequest, res: Response) {
    const id = req.params.id as string;
   ...
   */
  async setCommissionRate(req: AuthRequest, res: Response) {
    const id = req.params.id as string;
