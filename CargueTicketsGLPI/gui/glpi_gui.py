...
Empaquetable con:  pyinstaller --onefile --windowed --icon=iconCargueGLPI.ico --add-data "iconCargueGLPI.ico;." --add-data ".env;." --add-data "techselection.py;." glpi_gui.py
"""
...
class App(tk.Tk):
    ...
    def _upload(self):
        ...
        try:
            ...
            aviso.destroy()  # cierra la ventanita
